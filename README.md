# Emart - A simple eCommerce website

Emart is an open-source **Next.js eCommerce frontend** project.  
...
1. Clone the repo
    ...
    ```bash
    git clone https://github.com/EmartDev/Emart.git
    cd Emart
    ```
...
Thanks to everyone who contributes to **Emart**!